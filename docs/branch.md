...
branch: Q_unsmooth
status: experimental
base: legacy Vocos and SEANet line
used_in_thesis: no
...
Reorganized PyTorch Vocos, RVQ/FSQ and SEANet research snapshot with a single command dispatcher.
...
python tools/run.py train_vocos_vq --help
```
