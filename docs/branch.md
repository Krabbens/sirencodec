---
branch: codex/cuda-1to1-baseline
status: experimental
base: historical CUDA baseline 53fe7127
used_in_thesis: no
install: uv sync
...
CUDA one-to-one baseline used to compare the training workflow without branch-specific codec extensions.
